...
export const mockComponentsFromReports: ReplacementComponent[] = [
  {
    ...
    buildingName: "Tòa H",
    machineLabel: "01",
    reason: "Card mạng không hoạt động, mất kết nối mạng, không thể truy cập internet",
    quantity: 1
  },
  {
    id: "comp-report-002",
  ...
  },
  {
    ...
    buildingName: "Tòa H", 
    machineLabel: "08",
    reason: "Ổ cứng SSD bị bad sector nghiêm trọng, mất dữ liệu, không thể truy cập",
    quantity: 1
  },
  {
    id: "comp-report-004",
  ...
  },
  {
    ...
    buildingName: "Tòa H",
    machineLabel: "07",
    reason: "Nguồn cung cấp điện không ổn định, có tiếng kêu bất thường, điện áp không đều",
    quantity: 1
  },
  {
    id: "comp-report-007", 
...
export const mockComponentsFromReportsWithStatus: ComponentFromReport[] = mockComponentsFromReports.map((component, index) => ({
  ...component,
  reportDate: new Date(Date.now() - (index + 1) * 24 * 60 * 60 * 1000).toISOString().split('T')[0], // Các ngày khác nhau
  status: "Chờ xử lý",
