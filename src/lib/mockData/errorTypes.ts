...
export const errorTypes: ErrorType[] = [
  ...
  },
  {
    ...
    description: "Không thể kết nối internet hoặc mạng nội bộ. Có thể do lỗi card mạng, driver, cấu hình mạng hoặc cáp mạng bị hỏng.",
    createdAt: "2024-01-15T08:25:00Z"
  },
  {
    id: "ET007",
    name: "Máy hư màn hình",
    description: "Màn hình không hiển thị, hiển thị bị lỗi, nhấp nháy, hoặc có đường kẻ. Có thể do lỗi màn hình, cáp kết nối hoặc card đồ họa.",
    createdAt: "2024-01-15T08:30:00Z"
  },
  {
    id: "ET008",
    name: "Máy mất chuột",
    description: "Chuột không còn tại vị trí làm việc, có thể bị mất hoặc lấy nhầm. Cần thay thế chuột mới cho máy tính.",
    createdAt: "2024-01-15T08:35:00Z"
  },
  {
    id: "ET009",
    name: "Máy mất bàn phím",
    description: "Bàn phím không còn tại vị trí làm việc, có thể bị mất hoặc lấy nhầm. Cần thay thế bàn phím mới cho máy tính.",
    createdAt: "2024-01-15T08:40:00Z"
  },
  {
    id: "ET010",
    name: "Lỗi khác",
    description: "Các lỗi không thuộc các loại trên, cần mô tả chi tiết trong phần ghi chú khi báo cáo để kỹ thuật viên có thể hỗ trợ tốt hơn.",
