...
export const errorTypeStatsData = [
  { name: "Phần cứng máy tính", value: 35, color: "#8884d8" },
  { name: "Phần mềm/OS", value: 25, color: "#82ca9d" },
  { name: "Mạng/Internet", value: 20, color: "#ffc658" },
  { name: "Máy chiếu/TV", value: 12, color: "#ff7300" },
  { name: "Điều hòa/Điện", value: 8, color: "#e74c3c" },
];
