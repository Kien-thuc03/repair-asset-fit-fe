...
const mockRepairRequests: RepairRequestForList[] = [
  {
    ...
    assetLocation: "Tòa H - Phòng H301",
    issueType: "hardware",
    issueDescription:
      "Máy tính không khởi động được, có mùi cháy từ nguồn điện 500W",
    priority: "high",
    status: "pending",
    ...
    notes: "Cần thay nguồn điện mới ngay lập tức",
  },
  {
    id: "RR002",
    assetCode: "PC-H205-15",
    assetName: "Máy tính HP EliteDesk 800",
    assetLocation: "Tòa H - Phòng H205",
    issueType: "hardware",
    issueDescription: "RAM DDR4 8GB bị lỗi, máy không khởi động được",
    priority: "medium",
    status: "in_progress",
    reportedBy: "Lê Văn C",
    ...
    unit: "Khoa Công nghệ Thông tin",
    notes: "Đã kiểm tra RAM, đang chờ linh kiện mới",
  },
  {
    id: "RR003",
    assetCode: "PC-H704-08",
    assetName: "Máy tính Asus VivoPC",
    assetLocation: "Tòa H - Phòng H704",
    issueType: "hardware",
    issueDescription: "Ổ cứng SSD 256GB bị bad sector, mất dữ liệu",
    priority: "high",
    status: "completed",
    ...
    unit: "Khoa Công nghệ Thông tin",
    notes: "Đã thay SSD mới, phục hồi dữ liệu thành công",
  },
  {
    id: "RR004",
    assetCode: "PC-H508-11",
    assetName: "Máy tính MSI Pro",
    assetLocation: "Tòa H - Phòng H508",
    issueType: "hardware",
    issueDescription: "Card đồ họa GTX 1050 không hiển thị hình ảnh",
    priority: "medium",
    status: "pending",
    reportedBy: "Võ Thị F",
    reportedDate: "2024-01-13T11:20:00",
    assignedTo: "Hoàng Văn E",
    estimatedCompletionDate: "2024-01-16T14:00:00",
    unit: "Khoa Công nghệ Thông tin",
    notes: "Cần kiểm tra và có thể thay card đồ họa mới",
  },
  {
    id: "RR005",
    assetCode: "PC-H109-22",
    assetName: "Máy tính Lenovo ThinkCentre",
    assetLocation: "Tòa H - Phòng H109",
    issueType: "hardware",
    issueDescription: "CPU Intel i5 quá nóng, máy tự động tắt liên tục",
    priority: "high",
    status: "in_progress",
    reportedBy: "Phạm Thị D",
    reportedDate: "2024-01-16T07:45:00",
    assignedTo: "Lê Văn C",
    estimatedCompletionDate: "2024-01-17T12:00:00",
    unit: "Khoa Công nghệ Thông tin",
    notes: "Đang thay tản nhiệt và kiểm tra CPU",
  },
];
