...
import { CheckCircle, X, FileText, ArrowRight } from "lucide-react";

interface CreateReportSuccessModalProps {
  isOpen: boolean;
  onClose: () => void;
  listTitle?: string;
...
export default function CreateReportSuccessModal({
  isOpen,
  onClose,
  listTitle = "Danh sách đề xuất thay thế",
  equipmentCount = 0,
  title = "Chuyển sang lập tờ trình thành công!",
        ...
        <div className="text-center mb-6">
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-3 mb-4">
            ...
            <p className="text-xs text-blue-700">
              {equipmentCount} thiết bị → Chuyển sang lập tờ trình
            </p>
          </div>

          <p className="text-sm text-gray-600">
            Hệ thống đang mở form lập tờ trình với thông tin từ danh sách đã
            chọn. Vui lòng hoàn thiện thông tin và nộp tờ trình.
          </p>
        </div>
